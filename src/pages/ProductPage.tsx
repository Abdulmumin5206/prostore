        ...
        <ContentBlock spacing="none">
          {loading ? (
            <div className="pt-1 pb-2">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-x-4 lg:gap-x-6 gap-y-2 lg:gap-y-3">
                <div className="lg:col-span-8 xl:col-span-8">
                  <div className="space-y-3">
                    <div className="h-3 w-40 bg-gray-200 dark:bg-gray-800 rounded animate-pulse"></div>
                    <div className="h-10 w-2/3 bg-gray-200 dark:bg-gray-800 rounded-lg animate-pulse"></div>
                ...
                <div className="lg:col-span-4 xl:col-span-4 flex lg:items-start">
                  <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm px-4 py-3 mb-2 w-full">
                    <div className="h-4 w-32 bg-gray-200 dark:bg-gray-800 rounded mb-3 animate-pulse"></div>
                    <div className="h-4 w-40 bg-gray-200 dark:bg-gray-800 rounded mb-3 animate-pulse"></div>
                ...
                <div className="flex flex-col lg:col-span-8 lg:pt-1">
                  ...
                  <div className="grid grid-cols-5 gap-2 sm:hidden mt-2">
                    {Array.from({ length: 5 }).map((_, idx) => (
                      <div key={idx} className="rounded-md h-16 w-full bg-gray-200 dark:bg-gray-800 animate-pulse"></div>
                    ))}
                  </div>
                </div>
                ...
                <div className="flex flex-col lg:col-span-4 xl:col-span-4">
                  <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm px-4 pt-3 pb-2">
                    <div className="h-5 w-24 bg-gray-200 dark:bg-gray-800 rounded mb-4 animate-pulse"></div>
                    <div className="flex flex-wrap gap-2 mb-4">
                      {Array.from({ length: 3 }).map((_, idx) => (
                        <div key={idx} className="h-9 w-20 bg-gray-200 dark:bg-gray-800 rounded-lg animate-pulse"></div>
                      ))}
                    </div>
                    <div className="flex flex-wrap gap-2 mb-4">
                      {Array.from({ length: 4 }).map((_, idx) => (
                        <div key={idx} className="h-9 w-24 bg-gray-200 dark:bg-gray-800 rounded-lg animate-pulse"></div>
                      ))}
                    </div>
                    <div className="h-9 w-40 bg-gray-200 dark:bg-gray-800 rounded mb-2 animate-pulse"></div>
                    <div className="h-3 w-28 bg-gray-200 dark:bg-gray-800 rounded mb-4 animate-pulse"></div>
                    <div className="flex gap-2">
                      <div className="h-10 flex-[3] bg-gray-200 dark:bg-gray-800 rounded-lg animate-pulse"></div>
                      <div className="h-10 flex-1 bg-gray-200 dark:bg-gray-800 rounded-lg animate-pulse"></div>
                    </div>
                  </div>
                </div>
              </div>
