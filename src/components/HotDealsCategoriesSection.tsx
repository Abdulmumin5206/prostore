...
const HotDealsCategoriesSection: React.FC = () => {
  ...
  // Hot Deals categories data
  const categories: HotDealCategory[] = [
    {
      id: 'iphone-deal',
      name: 'iPhone 15 Pro',
    ...
    },
    {
      ...
      price: 'From $199',
      monthly: 'or $8.29/mo. for 24 mo.*'
    },
    {
      id: 'compare',
      name: 'Compare',
      subtitle: 'Find the best deals for you',
      image: '/Iphone_main/iphone_16pro_promax.jpg',
      price: 'Compare all deals',
    },
    {
      id: 'accessories',
      name: 'Accessories',
      ...
      image: '/Iphone_main/iphone_16_plus.jpg',
      price: 'Shop hot deals',
    },
    {
      id: 'see-all',
      name: 'See All',
      subtitle: 'Explore all hot deals',
      image: '/Iphone_main/iphone_15_plus.jpg',
    ...
    <section className="py-12 md:py-16 lg:py-20 2xl:py-24 bg-[#f5f5f7] dark:bg-black">
      <div className="pl-0 pr-0">
        <div className="pl-12 md:pl-16 lg:pl-12 xl:pl-16 2xl:pl-32 3xl:pl-44 max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl 2xl:max-w-3xl mr-0">
          <AppleHeadline>Hot Deals.</AppleHeadline>
          <Spacing size="sm" />
          <AppleSubheadline>
...
export default HotDealsCategoriesSection; 