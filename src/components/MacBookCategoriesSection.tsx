...
const MacBookCategoriesSection: React.FC = () => {
	...
	// MacBook categories data
	const categories: MacBookCategory[] = [
		{
			id: 'macbook-pro-16',
			name: 'MacBook Pro 16"',
			subtitle: 'MacBook Pro 14"',
			image: '/macbook_main/mac-card-40-macbookpro-14-16-202410.jpg',
			price: 'From $2,499',
			monthly: 'or $104.12/mo. for 24 mo.*'
		},
		{
			id: 'macbook-pro-14',
			name: 'MacBook Pro 14"',
			...
			image: '/macbook_main/mac-card-40-macbookpro-14-16-202410.jpg',
			price: 'From $1,999',
			monthly: 'or $83.29/mo. for 24 mo.*'
		},
		{
			id: 'macbook-air-15',
			name: 'MacBook Air 15"',
			image: '/macbook_main/mac-card-40-macbook-air-202503.jpg',
			price: 'From $1,299',
			monthly: 'or $54.12/mo. for 24 mo.*'
		},
		{
			id: 'macbook-air-13',
			name: 'MacBook Air 13"',
		...
		},
		{
			id: 'compare',
			name: 'Compare',
			subtitle: 'Find the MacBook that\'s right for you',
			image: '/macbook_main/mac-card-40-macbookpro-14-16-202410.jpg',
		...
		},
		{
			...
			image: '/macbook_main/mac-card-40-macbook-air-202503.jpg',
			price: 'Shop MacBook accessories',
		},
		{
			id: 'see-all',
			name: 'See All',
			subtitle: 'Explore the complete MacBook lineup',
			image: '/macbook_main/mac-card-40-macbookpro-14-16-202410.jpg',
		...
		<section className="py-12 md:py-16 lg:py-20 2xl:py-24 bg-[#f5f5f7] dark:bg-black">
			<div className="pl-0 pr-0">
				<div className="pl-12 md:pl-16 lg:pl-12 xl:pl-16 2xl:pl-32 3xl:pl-44 max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl 2xl:max-w-3xl mr-0">
					<AppleHeadline>MacBook.</AppleHeadline>
					<Spacing size="sm" />
					<AppleSubheadline>
					...
					>
						...
						>
							{categories.map((category, index) => (
								...
								>
									{category.id === 'see-all' ? (
										<div className="flex flex-col items-center justify-center h-full space-y-6 cursor-pointer transition-all duration-500 ease-out transform hover:scale-[1.02]" onClick={() => navigate('/products?category=Mac')}>
										...
										<div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm transition-all duration-500 ease-out overflow-hidden h-full flex flex-col transform hover:scale-[1.02] hover:shadow-md">
											...
											<div className="px-5 2xl:px-6 pt-2 pb-4 2xl:pb-6">
												<div className="flex items-center justify-between">
													...
													<button className="bg-blue-600 text-white rounded-full px-6 py-2 2xl:px-8 2xl:py-3 text-sm 2xl:text-base font-medium transition-all duration-300 hover:bg-blue-700 hover:shadow-md" onClick={() => navigate(`/products?category=Mac&subcategory=${encodeURIComponent(category.name)}`)}>
														Buy
													</button>
												</div>
											</div>
...
export default MacBookCategoriesSection; 